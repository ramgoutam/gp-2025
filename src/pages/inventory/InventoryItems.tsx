        ...
        <CardHeader className="flex flex-row items-center justify-between my-0 mx-0 px-0 py-[4px]">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-[200px] my-0 mx-px px-0 py-0 bg-slate-50">
              {initialColumns.map(column => <DropdownMenuCheckboxItem key={column} checked={selectedColumns.includes(column)} onCheckedChange={() => handleColumnToggle(column)} className="rounded px-[30px] my-[9px] py-[2px] mx-[7px] bg-slate-50 hover:bg-slate-200">
